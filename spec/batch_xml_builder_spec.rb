...
describe Emarsys::Broadcast::BatchXmlBuilder do
  # let(:valid_options){options = {name: 'batch_name', send_time: spec_time, sender: 'test@example.com'}}
  # let(:batch_builder){batch_builder = Emarsys::Broadcast::BatchXmlBuilder.new(valid_options)}
  # describe 'initialize' do
  #   context 'with valid options' do

  #     it 'should create a new instance of BatchXmlBuilder from valid options' do
  ...
  #       expect{Emarsys::Broadcast::BatchXmlBuilder.new(nil)}.to raise_error ArgumentError
  #     end

  #     it 'should raise ArgumentError when options does not contain a valid name' do
  #       expect{
  #         Emarsys::Broadcast::BatchXmlBuilder.new(send_time: Time.now, sender: 'test@example.com')
  #       }.to raise_error ArgumentError

  #       expect{
  #         Emarsys::Broadcast::BatchXmlBuilder.new(name: '', send_time: Time.now, sender: 'test@example.com')
  #       }.to raise_error ArgumentError
  #     end

  #     it 'should raise ArgumentError when options does not contain a valid send_time' do
  #       expect{
  #         Emarsys::Broadcast::BatchXmlBuilder.new(name: 'xml_name', sender: 'test@example.com')
  #       }.to raise_error ArgumentError
  #     end

  #     it 'should raise ArgumentError when options does not contain a sender' do
  #       expect{
  #         Emarsys::Broadcast::BatchXmlBuilder.new(send_time: Time.now, name: 'xml_name')
  #       }.to raise_error ArgumentError
  #     end

  #     it 'should raise ArgumentError when options contains empty sender' do
  #       expect{
  #         Emarsys::Broadcast::BatchXmlBuilder.new(name: 'xml_name', send_time: Time.now, sender: '')
  #       }.to raise_error ArgumentError
  #     end

  #     it 'should raise ArgumentError when options contains invalid sender email' do
  #       expect{
  #         Emarsys::Broadcast::BatchXmlBuilder.new(name: 'xml_name', send_time: Time.now, sender: 'invalid@sender yo')
  #       }.to raise_error ArgumentError
  #     end
  #   end
  # end
